...
class GenerationConfig:
    ...
    judges_rules_upgraded_prompts_paths: Dict[str, str] = field(
        default_factory=lambda: {
            "non_leakage_and_proper_scaffolding":"prompt_templates/judges/checklist/non_leakage_and_proper_scaffolding.txt",
        }
    )
